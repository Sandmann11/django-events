...
from . import views
from .views import EventList, EventDetails, EventAdd, EventUpdate, ArtistList, ArtistDetails, ArtistAdd, ArtistUpdate, VenueList, VenueDetails, VenueAdd, VenueUpdate
